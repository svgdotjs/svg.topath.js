...
const types = readFileSync('svg.topath.js.d.ts', 'utf8')
let emitted = false
...
const distExtras = {
  ...
  generateBundle() {
    ...
    this.emitFile({
      type: 'asset',
      fileName: 'svg.topath.d.mts',
      source: types
    })
    this.emitFile({
      type: 'asset',
      fileName: 'svg.topath.d.ts',
      source: types
    })
  }
}
